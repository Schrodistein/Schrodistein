 ...
 * compartir la app como página independiente.
 * Uso: node scripts/build-single.js [salida.html] */
const fs = require('fs');
...
`;
const dest = process.argv[2] || path.join(root, 'dist', 'escala-schrodistein.html');
